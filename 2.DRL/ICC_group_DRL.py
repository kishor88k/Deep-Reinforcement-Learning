...
def dqn_train(Episodes=1, iterations=20000):
    Reward_Scores = []
    ...
    for i in range(Episodes):
        ...
        for t in range(iterations):
            ...
            # increase the pointer only when group is chosen
            if current_action == 0:
            ...
            print("loss = {}, avg_reward = {} and Reward = {}".format(loss, Avg_Rewards[t], reward.squeeze().numpy()))
...
############# Save the Result##########
with open('Data9G_DRL.csv', "w") as f:
    writer = csv.writer(f)
