...
def dqn_train(Episodes=1, iterations=10000):
    ...
    lambda2 = 0.08#0.002#0.08#
    lambda3 = 0.01#0.005# 0.01#
    ...
    for i in range(Episodes):
        ...
        for t in range(iterations):
            ...
            print("loss = {} Avg_reward = {} and Reward = {}".format(loss, Avg_Rewards, reward.squeeze().numpy()))
